import AboutMePropsType from "./AboutMePropsType";
import ArticlePropsType from "./ArticlePropsType";
import BlobPropsType from "./BlobPropsType";
import CaptchaPropsType from "./CaptchaPropsType";
...
import SkillsExperiencePropsType from "./SkillsExperiencePropsType";

export type { 
    SectionWithIdPropsType, 
    NavBarLinkPropsType, 
    NavBarPropsType,
    ExperienceDescriptionPropsType,
    BlobPropsType,
    CardPropsType,
    CaptchaPropsType,
    ContactFormProps,
