export const articles = [
    {
        title: 'The Paradox of Twitter’s New One-Character Name: ‘X’',
        publishedAt: 'Aug 31 2023',
        link: 'https://medium.com/@youssefelgharbaoui/the-paradox-of-twitters-new-one-character-name-x-8c1568198325',
        sample: "In a bold and unprecedented move, Twitter has rebranded itself with a new name that consists of just one character: ‘X’. While the rebranding has certainly captured attention and sparked conversations, it has also raised a unique set of challenges for search algorithms and user experience.",
        imgName: 'x-twitter.jpeg'
    },
    {
